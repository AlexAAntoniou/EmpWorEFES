...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
  ...
  <xsl:template name="EmpWor-body-structure">
    <div id="stone">
  ...
  <xsl:template name="EmpWor-structure">
    <xsl:variable name="title">
      <xsl:call-template name="EmpWor-title" />
    </xsl:variable>
    <html>
      <head>
        <title>
      ...
      <body>
        ...
        <xsl:call-template name="EmpWor-body-structure" />
      </body>
    </html>
  </xsl:template>

  <xsl:template name="EmpWor-title">
    <xsl:choose>
